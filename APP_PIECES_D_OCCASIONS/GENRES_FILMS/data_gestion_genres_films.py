...
class GestionGenresFilms():
    def __init__ (self):
        try:
            ...
            flash("Dans Gestion genders users ...terrible erreur, il faut connecter une base de donnée", "danger")
            # DEBUG bon marché : Pour afficher un message dans la console.
    ...
    def genres_films_delete (self, valeurs_insertion_dictionnaire):
        try:
            ...
            with MaBaseDeDonnee() as mconn_bd:
                ...
                TypeError) as erreur:
            # DEBUG bon marché : Pour afficher un message dans la console.
            print(f"Problème genres_films_delete Gestions Genres users numéro de l'erreur : {erreur}")
            # C'est une erreur à signaler à l'utilisateur de cette application WEB.
            flash(f"Flash. Problème genres_films_delete Gestions Genres users  numéro de l'erreur : {erreur}", "danger")
            raise Exception(
                "Raise exception... Problème genres_films_delete Gestions Genres users  {erreur}")
    ...
    def delete_genre_data (self, valeur_delete_dictionnaire):
        try:
            ...
            if erreur.args[0] == 1451:
                ...
                # C'est une erreur à signaler à l'utilisateur de cette application WEB.
                flash(f"Flash. IMPOSSIBLE d'effacer !!! Ce genre est associé à des users dans la t_genres_films !!! : {erreur}", "danger")
                # DEBUG bon marché : Pour afficher un message dans la console.
                print(f"IMPOSSIBLE d'effacer !!! Ce genre est associé à des users dans la t_genres_films !!! : {erreur}")
