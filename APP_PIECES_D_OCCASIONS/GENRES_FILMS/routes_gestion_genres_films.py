...
from APP_PIECES_D_OCCASIONS.GENDERS.data_gestion_genders import GestionGenres
from APP_PIECES_D_OCCASIONS.GENRES_FILMS.data_gestion_genres_films import GestionGenresFilms


# ---------------------------------------------------------------------------------------------------
# OM 2020.04.26 Définition d'une "route" /genres_films_afficher_concat
# Récupère la liste de tous les users et de tous les genders associés aux users.
# ---------------------------------------------------------------------------------------------------
...
def genres_films_afficher_concat (id_film_sel):
    ...
    if request.method == "GET":
        try:
            ...
            print(" data genders", data_genres_films_afficher_concat, "type ", type(data_genres_films_afficher_concat))

            # Différencier les messages si la table est vide.
            if data_genres_films_afficher_concat:
                # OM 2020.04.09 La ligne ci-dessous permet de donner un sentiment rassurant aux utilisateurs.
                flash(f"Données genders affichés dans GenresFilms!!", "success")
            else:
...
# Récupère la liste de tous les genders du film sélectionné.
# Nécessaire pour afficher tous les "TAGS" des genders, ainsi l'utilisateur voit les genders à disposition
# ---------------------------------------------------------------------------------------------------
...
def gf_edit_genre_film_selected ():
    if request.method == "GET":
        try:
            ...
            # l'utilisateur clique sur le lien "Modifier genders de ce film" et on récupère la valeur de "id_film" grâce à la variable "id_film_genres_edit_html"
            # <a href="{{ url_for('gf_edit_genre_film_selected', id_film_genres_edit_html=row.id_film) }}">Modifier les genders de ce film</a>
            ...
            # 2) Sélection des genders "déjà" attribués pour le film.
            # 3) Sélection des genders "pas encore" attribués pour le film choisi.
            ...
            # les genders qui ne sont pas encore sélectionnés.
            ...
            # Dans le composant "tags-selector-tagselect" on doit connaître
            # les genders qui sont déjà sélectionnés.
            ...
            if lst_data_film_selected == [None]:
                ...
                # OM 2020.04.09 La ligne ci-dessous permet de donner un sentiment rassurant aux utilisateurs.
                flash(f"Données genders affichées dans GenresFilms!!", "success")
...
def gf_update_genre_film_selected ():
    if request.method == "POST":
        try:
            ...
            # Récupère la liste des genders qui ne sont pas associés au film sélectionné.
            ...
            # Récupère la liste des genders qui sont associés au film sélectionné.
            ...
            # Récupère ce que l'utilisateur veut modifier comme genders dans le composant "tags-selector-tagselect"
            ...
            # Pour le film sélectionné, parcourir la liste des genders à INSÉRER dans la "t_genres_films".
            ...
            # Pour le film sélectionné, parcourir la liste des genders à EFFACER dans la "t_genres_films".
            # Si la liste est vide, la boucle n'est pas parcourue.
            ...
            # Récupère les données grâce à une requête MySql définie dans la classe GestionGenres()
            # Fichier data_gestion_genders.py
            # Afficher seulement le film dont les genders sont modifiés, ainsi l'utilisateur voit directement
    ...
    # on affiche les users et le(urs) genre(s) associé(s).
    return render_template("genres_films/genres_films_afficher.html",
                           data=data_genres_films_afficher_concat)
